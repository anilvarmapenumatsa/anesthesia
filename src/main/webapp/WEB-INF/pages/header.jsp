	...
	<nav class="navbar navbar-default navbar-fixed-top navibar-inner">
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://www.utoledo.edu/"><img
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" style="background: #003E7E;">
							<li><a
								...
								style="color: white;">Evaluation</a></li>
							<!-- <li><a href="/SpringSecurity/resultsofresidentevaluation"
								style="color: white;">Evaluation Results</a></li> -->
							<li><a href="/SpringSecurity/resultsofuserdata"
								style="color: white;">Something else here</a></li>
							<li><a href="/SpringSecurity/userform" style="color: white;">Separated
									link</a></li>
